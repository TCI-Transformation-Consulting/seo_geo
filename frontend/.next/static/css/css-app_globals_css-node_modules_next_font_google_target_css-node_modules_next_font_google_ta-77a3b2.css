...
.gradient-accent {
  background-image: radial-gradient(1200px 400px at 10% 0%, rgba(99, 102, 241, 0.15) 0%, rgba(99, 102, 241, 0) 60%),
    radial-gradient(1200px 400px at 90% 0%, rgba(6, 182, 212, 0.15) 0%, rgba(6, 182, 212, 0) 60%);
}
